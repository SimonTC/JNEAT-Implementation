...
import jNeatCommon.*;
   ...
   */
	   public Network(Vector in, Vector out, Vector all, int xnet_id) 
	  {
	   ...
	   /**
	    * STC
	    * Activates all nodes in the network
...
//			   System.exit(4);
			...
			while (itr_node.hasNext()) 
			{
			   ...
			   //Only activate if some active input came in
				  if (_node.active_flag) 
				  {
					 ...
					 //TODO: Maybe change constants used in the fsigmoid function?? //STC
	   ...
	   public void flush() 
	  {
	   ...
	   /**
	    * STC
	    * Loads the sensor values of all sensors in the network
	    * @param sensvals Array of values for the sensors
	    */
   ...
   */
	   public int max_depth() 
	  {
	   ...
	   /**
	    * STC 30-10-13
	    * Tests if there is an output node that has not been activated
	    * @return True if at least one output node hasn't been activated. 
	    * False if all output nodes has been activated
	    */
	   public boolean outputsoff() 
	  {
	   ...
	   /**
	    * STC
	    * Prints a list of all activated notes with their information
	    * @param s text written before the list is printed
	    */
