...
/** A Population is a group of Organisms including their species */
   ...
   /** If  too high, leads to delta coding process. */
	   ...
	   */                        
		   ...
		   /**
		    * STC
		    * Create population based on single starter genome
		    * @param g
		    * @param size
		    */
...
//					 System.out.print("\n passo de qui");
	   ...
	   */
		  ...
		  // al momento NUM_STOLEN=1
			 ...
			 //The following keeping species constant is added by STC.
			 //The code is from the NEAT web page page
		  ...
		  //As this happens, create master organism list for the new generation
			 ...
			 while (itr_specie.hasNext()) 
			 {
				...
				//from the current species  recostruct thge master list organisms
				   ...
				   //add ugo ******************************************************************************************
					  _organism.genome.getPhenotype().setNet_id( _organism.genome.getGenome_id());
